package com.example.pasir_lipior_michal.exception;
...
public class GraphQLExceptionHandler implements DataFetcherExceptionResolver {
    ...
    @Override
    public Mono<List<GraphQLError>> resolveException(@NotNull Throwable ex, @NotNull DataFetchingEnvironment env) {
