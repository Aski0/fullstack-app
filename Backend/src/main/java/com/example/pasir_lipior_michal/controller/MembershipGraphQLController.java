...
import com.example.pasir_lipior_michal.dto.GroupResponseDTO;
import com.example.pasir_lipior_michal.dto.MembershipDTO;
import com.example.pasir_lipior_michal.dto.MembershipResponseDTO;
...
import com.example.pasir_lipior_michal.service.MembershipService;
    ...
    public List<MembershipResponseDTO> groupMembers(@Argument Long groupId) {
        ...
        return membershipRepository.findByGroupId(group.getId()).stream()
                .map(membership -> new MembershipResponseDTO(
                        ...
                        membership.getUser().getEmail() // total utajony email
                ))
                .toList();
    }
